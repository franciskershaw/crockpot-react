  ...
  return (
    <div className="flex flex-col gap-2.5 md:gap-3">
      ...
      <SliderPrimitive.Root
        className="relative flex h-4 w-full touch-none items-center select-none md:h-4.5"
        min={bounds.minTime}
        max={bounds.maxTime}
        step={STEP_MINUTES}
        value={draft}
      ...
      >
        <SliderPrimitive.Track className="relative h-1.25 grow rounded-full bg-slider-track">
